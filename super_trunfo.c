...
int main()
{
  ...
  {
    printf("Aviso: Área igual a zero para Carta 1. Densidade Populacional não pode ser calculada.\n");
  }

  if (Populacao1 != 0)
  {
    PIBPerCapita1 = PIB1 * 1e9 / Populacao1; // PIB em reais por habitante
  }
  else
  {
    printf("Aviso: População igual a zero para Carta 1. PIB per Capita não pode ser calculado.\n");
  }
  ...
  if (Area2 != 0)
  {
    DensidadePopulacional2 = Populacao2 / Area2; // habitantes por km²
  }
  else
  {
    printf("Aviso: Área igual a zero para Carta 2. Densidade Populacional não pode ser calculada.\n");
  }

  if (Populacao2 != 0)
  {
    PIBPerCapita2 = PIB2 * 1e9 / Populacao2; // PIB em reais por habitante
  }
  else
  {
    printf("Aviso: População igual a zero para Carta 2. PIB per Capita não pode ser calculado.\n");
  }
  ...
  while (continuar)
  {
    ...
    // Pontuação do primeiro atributo usando operador ternário
    if (opcao1 == 5)
    { // Densidade Populacional (menor vence)
      pontos_carta1 += (valor1_carta1 < valor1_carta2);
      pontos_carta2 += (valor1_carta2 < valor1_carta1);
    }
    else
    ...
    // Pontuação do segundo atributo usando operador ternário
    if (opcao2 == 5)
    { // Densidade Populacional (menor vence)
      pontos_carta1 += (valor2_carta1 < valor2_carta2);
      pontos_carta2 += (valor2_carta2 < valor2_carta1);
    }
    else
    { // Demais atributos (maior vence)
      pontos_carta1 += (valor2_carta1 > valor2_carta2);
